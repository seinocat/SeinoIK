...
namespace XenoIK.Editor
{
    ...
    public class LookAtCtrlInspector : IKInspector
    {
        ...
        protected override void DrawInspector()
        {
            ...
            EditorGUILayout.PropertyField(this.serializedObject.FindProperty("detectAngle"), new GUIContent("发现角度"));
            EditorGUILayout.PropertyField(this.serializedObject.FindProperty("followAngle"), new GUIContent("跟随角度"));
