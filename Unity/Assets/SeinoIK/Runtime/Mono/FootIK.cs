    ...
    public class FootIK : MonoBehaviour
    {
        ...
        private void OnSolverUpdate()
        {
            ...
            if (this.GroundSolver.AutoHighWeight)
            {
                ...
                {
                    this.GroundSolver.HighWeight = SeinoUtils.LerpValue(this.GroundSolver.HighWeight, target, this.GroundSolver.FootSpeed, this.GroundSolver.FootSpeed);
                }
                else
                {
                    this.GroundSolver.HighWeight = SeinoUtils.LerpDamper(this.GroundSolver.HighWeight, target, ref this.m_WeightVelocity, this.GroundSolver.WeightDamperTime, this.GroundSolver.LerpType);
                }
        ...
        public void AutoBindRootAndPelvis()
        {
            ...
            if (this.Root == null) this.Root = SeinoTools.FindTargetBone(this.transform.parent, "root", true);
