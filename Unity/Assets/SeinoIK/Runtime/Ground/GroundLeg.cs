...
namespace SeinoIK.Runtime.Ground
{
    public class GroundLeg
    {
        ...
        public void Solve()
        {
            ...
            //插值
            this.FootOffset = SeinoUtils.LerpValue(this.FootOffset, offsetTarget, this.m_GroundSolver.FootSpeed, this.m_GroundSolver.FootSpeed);
        ...
        private void GetHeightRotation(Vector3 hitNormal, Vector3 hitPoint)
        {
            ...
            Vector3 point = SeinoUtils.LineToPlane(this.m_FootPosition, -this.Up, hitNormal, hitPoint);
