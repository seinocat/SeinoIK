...
namespace XenoIK
{
    ...
    public class IKSolverLookAt : IKSolver
    {
        ...
        {
            if (this.head != null) this.IKPosition = this.head.Position + this.root.forward * 3f;
            else if (this.spines.Count > 0) this.IKPosition = this.spines.FindLastBone().Position + this.root.forward * 3f;
